    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mx-auto mb-8" style={{ maxWidth: "800px" }}>
        <p className="text-lg mb-4">
          ...
          agent claims support there are often caveats. On top of this there's
          no universal standard for defining, including, and loading context for
          agents.
        </p>
        <p className="text-lg mb-4">
